...
materialParameters.shadeColor = '#8e19b8';
materialParameters.lightColor = '#f3ffa3';
materialParameters.shadowRepeitions = 100.0;
materialParameters.lightRepeitions = 100.0;
...
const material = new THREE.ShaderMaterial({
    ...
    uniforms:
    {
        ...
        uShadowRepeitions: new THREE.Uniform(100.0),
        uLightRepeitions: new THREE.Uniform(100.0),
        uShadeColor: new THREE.Uniform(new THREE.Color(materialParameters.shadeColor)),
        uLightColor: new THREE.Uniform(new THREE.Color(materialParameters.lightColor)),
    }
})

gui.add(materialParameters, 'shadowRepeitions', 1, 300, 1)
    .onChange(() =>
    {
        material.uniforms.uShadowRepeitions.value = materialParameters.shadowRepeitions
    })

gui.add(materialParameters, 'lightRepeitions', 1, 300, 1)
    .onChange(() =>
    {
        material.uniforms.uLightRepeitions.value = materialParameters.lightRepeitions
    })
...
gui
    ...
    .onChange(() =>
    {
        material.uniforms.uShadeColor.value.set(materialParameters.shadeColor)
    })
