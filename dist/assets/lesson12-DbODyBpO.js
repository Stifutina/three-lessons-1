import{M as u,a3 as ae,a4 as se,O as ne,B as K,V as N,S as ie,T as re,a5 as t,d as S,a0 as Z,o as w,G as q,a6 as le,q as ce,a7 as de,t as he,Q as pe,u as P,P as ue,W as fe,a2 as me,a8 as _e}from"./three.module-DuSFNCfV.js";/* empty css              */import{O as we}from"./OrbitControls-C7UUza7_.js";import{G as ge}from"./lil-gui.esm-hsJpI9MV.js";class ve{constructor(){this._previousTime=0,this._currentTime=0,this._startTime=G(),this._delta=0,this._elapsed=0,this._timescale=1,this._usePageVisibilityAPI=typeof document<"u"&&document.hidden!==void 0,this._usePageVisibilityAPI===!0&&(this._pageVisibilityHandler=Me.bind(this),document.addEventListener("visibilitychange",this._pageVisibilityHandler,!1))}getDelta(){return this._delta/1e3}getElapsed(){return this._elapsed/1e3}getTimescale(){return this._timescale}setTimescale(o){return this._timescale=o,this}reset(){return this._currentTime=G()-this._startTime,this}dispose(){return this._usePageVisibilityAPI===!0&&document.removeEventListener("visibilitychange",this._pageVisibilityHandler),this}update(o){return this._usePageVisibilityAPI===!0&&document.hidden===!0?this._delta=0:(this._previousTime=this._currentTime,this._currentTime=(o!==void 0?o:G())-this._startTime,this._delta=(this._currentTime-this._previousTime)*this._timescale,this._elapsed+=this._delta),this}}function G(){return performance.now()}function Me(){document.hidden===!1&&this.reset()}class E extends u{constructor(){const o=E.SkyShader,s=new ae({name:o.name,uniforms:se.clone(o.uniforms),vertexShader:o.vertexShader,fragmentShader:o.fragmentShader,side:ne,depthWrite:!1});super(new K(1,1,1),s),this.isSky=!0}}E.SkyShader={name:"SkyShader",uniforms:{turbidity:{value:2},rayleigh:{value:1},mieCoefficient:{value:.005},mieDirectionalG:{value:.8},sunPosition:{value:new N},up:{value:new N(0,1,0)}},vertexShader:`
...
//# sourceMappingURL=lesson12-DbODyBpO.js.map
